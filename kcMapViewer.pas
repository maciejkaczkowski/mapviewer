...
type
  ...
  private
    ...
    procedure RepaintMap(X, Y: Integer; Cached: Boolean = False);
    procedure RepaintMap(Cached: Boolean);
    ...
    begin
      ...
      try
        ...
        begin
          ...
          image.Canvas.FillRect(0, 0, TILE_SIZE, TILE_SIZE);
        end;

        image.Canvas.Brush.Color := clGray;
        image.Canvas.Brush.Style := bsSolid;
        image.Canvas.FrameRect(0, 0, TILE_SIZE, TILE_SIZE);
...
procedure TMapViewer.DownloadTile(X, Y, Z: Integer; Graphic: TBitmap);
  ...
  function CalcPixels(img: TPortableNetworkGraphic): Integer;
